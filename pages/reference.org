...
*** Syntax
    ...
    implicitly typed definition
        = "define", ( variable definition | function definition );
    explicitly typed definition
        = "define:", ( typed variable definition | typed function definition );

    variable definition
        = name, expression ;
    function definition
        = "(", name, parameter, { parameter }, ")", expression ;

    typed variable definition
        = name, definition type, expression ;
    typed function definition
        = "(", name, parameter, { parameter }, ")", definition type, expression ;

    name = small identifier ;
    parameter = small identifier ;

    definition type = polytype | monotype ;
    polytype = "(", "forall", "(", type variable, { type variable }, ")"
                            , monotype, ")" ;
    #+END_SRC
...
*** Syntax
    :PROPERTIES:
    :CUSTOM_ID: TypeDefs-Syntax
    :END:
    #+BEGIN_SRC bnf
    datatype definition
        = "(", "type", datatype signature, { datatype variant }, ")" ;

    datatype signature
        = type name | "(", type name, type variable, { type variable }, ")" ;

    datatype variant
        = constructor | "(", constructor, monotype, { monotype }, ")" ;

    type name = big identifier ;
    constructor = big identifier ;
    #+END_SRC
...
*** Syntax
    See [[#TypeDefs-Syntax][Type definitions/Syntax]].
